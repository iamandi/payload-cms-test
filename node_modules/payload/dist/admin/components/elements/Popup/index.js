...
const Popup = (props) => {
    const { render, align = 'center', size = 'small', color = 'light', button, buttonType = 'default', children, showOnHover = false, horizontalAlign = 'left', initActive = false, onToggleOpen, } = props;
