...
const DefaultList = (props) => {
    const { collection, collection: { upload, slug, labels: { singular: singularLabel, plural: pluralLabel, }, }, data, newDocumentURL, setListControls, setSort, columns, hasCreatePermission, } = props;
    ...
    return (React.createElement("div", { className: baseClass },
        ...
        React.createElement("div", { className: `${baseClass}__wrap` },
            ...
            React.createElement("div", { className: `${baseClass}__page-controls` },
                ...
                data?.totalDocs > 0 && (React.createElement("div", { className: `${baseClass}__page-info` },
                    data.page,
                    "-",
