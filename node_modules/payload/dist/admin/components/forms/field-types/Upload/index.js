...
const Upload = (props) => {
    ...
    const { path: pathFromProps, name, required, admin: { readOnly, style, width, } = {}, label, validate = upload, relationTo, fieldTypes, } = props;
    ...
    return (React.createElement("div", { className: classes, style: {
        ...
        collection?.upload && (React.createElement(React.Fragment, null,
            (internalValue && !missingFile) && (React.createElement(FileDetails, Object.assign({}, collection.upload, internalValue, { handleRemove: () => {
                    setInternalValue(undefined);
                    setValue(null);
                } }))),
            ...
            React.createElement(AddModal, Object.assign({}, {
                collection,
                slug: addModalSlug,
                fieldTypes,
                setValue: (val) => {
            ...
            React.createElement(SelectExistingModal, Object.assign({}, {
                collection,
