...
function deserialize(node, opts) {
  var _opts, _opts$nodeTypes, _opts$linkDestination, _ref, _node$value, _extends2, _extends3, _extends4;
  ...
  var types = _extends({}, defaultNodeTypes, opts.nodeTypes, {
    heading: _extends({}, defaultNodeTypes.heading, (_opts = opts) === null || _opts === void 0 ? void 0 : (_opts$nodeTypes = _opts.nodeTypes) === null || _opts$nodeTypes === void 0 ? void 0 : _opts$nodeTypes.heading)
  });

  var linkDestinationKey = (_opts$linkDestination = opts.linkDestinationKey) !== null && _opts$linkDestination !== void 0 ? _opts$linkDestination : 'link';
  var children = [{
    text: ''
  }];
...
function serialize(chunk, opts) {
  ...
  if (children === '') return; // Never allow decorating break tags with rich text formatting,
