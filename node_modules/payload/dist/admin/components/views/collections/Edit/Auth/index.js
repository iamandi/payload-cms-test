...
const Auth = (props) => {
    ...
    return (React.createElement("div", { className: baseClass },
        ...
        React.createElement(Button, { size: "small", buttonStyle: "secondary", onClick: () => unlock() }, "Force Unlock"),
        ...
        verify && (React.createElement(Checkbox, { label: "Verified", name: "_verified", admin: {
                readOnly: true,
            } }))));
};
export default Auth;
