...
const SelectExistingUploadModal = (props) => {
    const { setValue, collection, collection: { slug: collectionSlug, } = {}, slug: modalSlug, } = props;
    ...
    return (React.createElement(Modal, { className: classes, slug: modalSlug }, isOpen && (React.createElement(MinimalTemplate, { width: "wide" },
        ...
        React.createElement(UploadGallery, { docs: data?.docs, collection: collection, onCardClick: (doc) => {
                setValue(doc);
                closeAll();
            } }),
