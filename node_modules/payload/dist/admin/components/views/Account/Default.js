...
const DefaultAccount = (props) => {
    ...
    return (React.createElement("div", { className: classes },
        React.createElement(Form, { className: `${baseClass}__form`, method: "put", action: action, initialState: initialState, disabled: !hasSavePermission },
            React.createElement("div", { className: `${baseClass}__main` },
                ...
                React.createElement("div", { className: `${baseClass}__edit` },
                    ...
                    !isLoading && (React.createElement(React.Fragment, null,
                        ...
                        React.createElement(Auth, { useAPIKey: auth.useAPIKey, collection: collection, email: data?.email }),
                        React.createElement(RenderFields, { operation: "update", permissions: permissions.fields, readOnly: !hasSavePermission, filter: (field) => field?.admin?.position !== 'sidebar', fieldTypes: fieldTypes, fieldSchema: fields }))))),
            React.createElement("div", { className: `${baseClass}__sidebar` },
                React.createElement("ul", { className: `${baseClass}__collection-actions` }, (permissions?.create?.permission) && (React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: `${baseClass}__document-actions${preview ? ` ${baseClass}__document-actions--with-preview` : ''}` },
                    React.createElement(PreviewButton, { generatePreviewURL: preview }),
                    hasSavePermission && (React.createElement(FormSubmit, null, "Save"))),
                React.createElement("div", { className: `${baseClass}__api-url` },
                ...
                React.createElement("ul", { className: `${baseClass}__meta` },
                    React.createElement("li", null,
                        ...
                        React.createElement("div", null, data?.id)),
