                    ...
                    !isLoading && (React.createElement(React.Fragment, null,
                        React.createElement("header", { className: `${baseClass}__header` },
                            React.createElement("h1", null,
                                React.createElement(RenderTitle, Object.assign({}, { data, useAsTitle, fallback: '[Untitled]' })))),
                        auth && (React.createElement(Auth, { useAPIKey: auth.useAPIKey, requirePassword: !isEditing, verify: auth.verify, collection: collection, email: data?.email })),
                        upload && (React.createElement(Upload, Object.assign({ data: data }, upload))),
                        React.createElement(RenderFields, { operation: isEditing ? 'update' : 'create', readOnly: !hasSavePermission, permissions: permissions.fields, filter: (field) => (!field?.admin?.position || (field?.admin?.position !== 'sidebar')), fieldTypes: fieldTypes, fieldSchema: fields }))))),
            React.createElement("div", { className: `${baseClass}__sidebar` },
                React.createElement("div", { className: `${baseClass}__sidebar-sticky` },
                    React.createElement("div", { className: `${baseClass}__sidebar-sticky-wrap` },
                        isEditing ? (React.createElement("ul", { className: `${baseClass}__collection-actions` },
                            (permissions?.create?.permission) && (React.createElement(React.Fragment, null,
                            ...
                            permissions?.delete?.permission && (React.createElement("li", null,
                        ...
                        React.createElement("div", { className: `${baseClass}__document-actions${(preview && isEditing) ? ` ${baseClass}__document-actions--with-preview` : ''}` },
                            isEditing && (React.createElement(PreviewButton, { generatePreviewURL: preview })),
                            hasSavePermission && (React.createElement(FormSubmit, null, "Save"))),
                        isEditing && (React.createElement("div", { className: `${baseClass}__api-url` },
                        ...
                        !isLoading && (React.createElement(React.Fragment, null,
                            React.createElement("div", { className: `${baseClass}__sidebar-fields` },
                                React.createElement(RenderFields, { operation: isEditing ? 'update' : 'create', readOnly: !hasSavePermission, permissions: permissions.fields, filter: (field) => field?.admin?.position === 'sidebar', fieldTypes: fieldTypes, fieldSchema: fields })),
                            isEditing && (React.createElement("ul", { className: `${baseClass}__meta` },
                                ...
                                timestamps && (React.createElement(React.Fragment, null,
                                    data.updatedAt && (React.createElement("li", null,
                                        ...
                                        React.createElement("div", null, format(new Date(data.updatedAt), 'MMMM do yyyy, h:mm a')))),
                                    data.createdAt && (React.createElement("li", null,
                                        React.createElement("div", { className: `${baseClass}__label` }, "Created"),
                                        React.createElement("div", null, format(new Date(data.createdAt), 'MMMM do yyyy, h:mm a'))))))))))))))));
};
