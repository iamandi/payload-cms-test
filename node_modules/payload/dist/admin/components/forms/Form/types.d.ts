...
export declare type Submit = (e: React.FormEvent<HTMLFormElement>) => void;
export declare type ValidateForm = () => Promise<boolean>;
export declare type CreateFormData = () => FormData;
...
export declare type GetDataByPath = (path: string) => unknown;
